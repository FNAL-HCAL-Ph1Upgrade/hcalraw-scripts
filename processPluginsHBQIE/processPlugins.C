...
int main(int argc, char *argv[])
{
    ...
    const std::vector<PluginPassInfo>& plugins = {
        ...
        {"capID0pedestal", 0.0,  35.0, { 1.4,  4.5}, { 1.7,  8.5},
